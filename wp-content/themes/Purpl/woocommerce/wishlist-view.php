...
<form id="yith-wcwl-form" action="<?php echo esc_url( YITH_WCWL()->get_wishlist_url( 'view' . ( $wishlist_meta['is_default'] != 1 ? '/' . $wishlist_meta['wishlist_token'] : '' ) ) ) ?>" method="post" class="woocommerce wrapper">
        ...
        if( count( $wishlist_items ) > 0 ) :
            foreach( $wishlist_items as $item ) :
                ...
                if( $product !== false && $product->exists() ) :
                    ...
                    ?>
                    <div class="row" id="yith-wcwl-row-<?php echo $item['prod_id'] ?>" data-row-id="<?php echo $item['prod_id'] ?>">
                        <?php if( $show_cb ) : ?>
                            <div class="col col-sm-2 product-checkbox">
                        ...
                        <div class="col col-sm-1 product-remove">
                            <div>
                        ...
                        <div class="col col-xs-4 col-sm-2 product-thumbnail">
                            <a href="<?php echo esc_url( get_permalink( apply_filters( 'woocommerce_in_cart_product', $item['prod_id'] ) ) ) ?>">
                                <?php echo $product->get_image() ?>
                            </a>
                        </div>

                        <div class="col col-xs-8 col-sm-4 product-name">
                            ...
                            <?php do_action( 'yith_wcwl_table_after_product_name', $item ); ?> <br/>
                        ...
                        <?php if( $show_stock_status ) : ?>
                            <div class="col col-sm-3 product-stock-status">
                                <?php
                        ...
                        <div class="col col-sm-3 product-add-to-cart">
                            <!-- Date added -->
                            <?php
            ...
            <div class="row">
                <div class="wishlist-empty"><?php _e( 'No products were added to the wishlist', 'yith-woocommerce-wishlist' ) ?></div>
            </div>
        <?php
        endif;
